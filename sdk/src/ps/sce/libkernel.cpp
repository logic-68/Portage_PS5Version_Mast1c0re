...
int PS::Sce::Kernel::Sysctlbyname(const char * name, void * oldp, size_t * oldlenp, void * newp, size_t newlen)
{
    return (int)PS::Breakout::call(LIBKERNEL(LIB_KERNEL_SYSCTLBYNAME), PVAR_TO_NATIVE(name), PVAR_TO_NATIVE(oldp), PVAR_TO_NATIVE(oldlenp), PVAR_TO_NATIVE(newp), newlen);
}
#endif
#endif